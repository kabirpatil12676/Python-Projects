...
def count_down(count):
    ...
    if count > 0:
        ...
        for _ in range(math.floor(reps/2)):
            marks +="✔️"
        checkpoint_label.config(text=marks)
...
#checkpoint Label
checkpoint_label = Label(font=(FONT_NAME,10,"normal"))
checkpoint_label.config(bg=YELLOW,fg=GREEN)
checkpoint_label.grid(column=1,row=3)
